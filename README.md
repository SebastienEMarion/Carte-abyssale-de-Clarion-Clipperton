...
* **Expansion des fonds océaniques** : Dans son ouvrage, _History of Sea Basins_, Harry Hess parle non seulement des théories antérieures sur l'hypothèse d'une expansion des fonds océaniques, en tant que géologue, mais évoque aussi avec une carte la dorsale Est-Pacifique : [2] "_Figure 10. Contour approximatif de la dorsale Est-Pacifique, qui représente possiblement une dorsale océanique si jeune qu'elle n'a pas encore développé une zone de rift médiane et que des sédiments antérieurs à la dorsale sont encore sur sa croûte_". La dorsale océanique participe à l'expansion des fonds océaniques.
* **Sondeurs multifaisceaux** : [4] "*Aujourd'hui, on utilise des sondeurs actifs, ou le SONAR* (SOund NAvigation and Ranging)*. Un transducteur émet une impulsion sonore qui rebondit ensuite sur le fond de l'océan, revenant au transducteur comme un écho. Le temps nécessaire pour que le son voyage à travers la colonne d'eau [dite pélagique] est enregistré, et ensuite calculé pour fournir une mesure de la profondeur. Les scientifiques à l'USGS (Institut d'études géologiques des États-Unis) au centre* St. Petersburg Coastal and Marine Science *utilisent principalement deux types de transducteurs SONAR, un échosondeur à faisceau unique ; et un échosondeur multifaisceaux. Le premier type répète une seule impulsion sonore directement sous le navire, ne donnant qu'une seule mesure de la profondeur sous la ligne traversée. Un transducteur multifaisceau répète des émissions de centaines de pulsations sonores comme un éventail sous le navire, fournissant une large étendue de mesures de la profondeur, perpendiculaire à la ligne de navigation du navire.*"
# Bibliographie :
